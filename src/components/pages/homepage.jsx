    ...
    <div className="min-h-screen bg-amber-50">
      ...
      <div className="relative bg-stone-900 text-amber-50 py-24 px-4 mt-14 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-6xl font-serif font-normal mb-6 tracking-tight">
            BE MEN
          </h1>
        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
            {filteredProducts.map((product, index) => {
              ...
              const animationDelay = isLoaded ? `${(index % 6) * 200}ms` : '0ms';
                ...
                >
                  ...
                  <div className="relative overflow-hidden bg-stone-100">
                    <div className="aspect-[4/5] relative">
                      ...
                      {/* Vintage Overlay */}
                      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-stone-900/20 group-hover:to-stone-900/30 transition-all duration-500" />
                  ...
                  {/* Hover Border Effect */}
                  <div className="absolute inset-0 border-2 border-transparent group-hover:border-stone-900/10 rounded-lg pointer-events-none transition-all duration-500" />
                </div>
              );
            })}
          </div>
